    ...
    render() {
        return (
            <div className="Weather">
                <ButtonsPanel tempDescMethod={this.sortTempDesc} tempAscMethod={this.sortTempAsc} filterCitiesListMethod={this.filterCitiesList} />
                <input ref={element => this._inputFilter = element} onChange={this.filterCitiesList} type="text" placeholder="Search City" />
